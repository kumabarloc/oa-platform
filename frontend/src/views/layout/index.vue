        ...
        <div class="right">
          <el-dropdown @command="handleCommand">
            <span class="user-info">
              <el-avatar :size="32">{{ userInfo?.nickName?.[0] || 'U' }}</el-avatar>
...
const allMenus = [
  ...
  },
  {
    ...
    icon: 'Document',
    children: [
      { id: 31, menuName: '发文管理', path: '/document/dispatch', perms: 'oa:document:list' },
      { id: 32, menuName: '收文管理', path: '/document/receive', perms: 'oa:document:list' },
    ],
  },
]
